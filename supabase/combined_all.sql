...
-- ============================================================================
-- 0006_class_stream.sql — teacher/school posts to a class, students reply
-- ============================================================================
-- A shared, per-class feed the teacher (or their school's admin) posts to,
-- with every student in the class able to reply. Deliberately NOT private
-- 1:1 teacher-student messaging (bp_messages stays teacher<->parent only) —
-- a stream everyone in the class can see is both closer to how Google
-- Classroom actually works and avoids the child-safety questions private
-- teacher-student DMs would raise. Posts can carry a link and/or an image
-- URL; there's no new storage bucket here, images are pasted URLs rather
-- than uploads, to avoid needing another storage policy migration on top
-- of this one.
...
-- ============================================================================
-- 0007_student_school_id.sql — a school-created student's school before any class assignment
-- ============================================================================
